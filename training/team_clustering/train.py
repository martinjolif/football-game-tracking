...
from training.team_clustering.utils import build_items_from_csv, plot_umap
...
with mlflow.start_run():
    ...
    umap_path = best_path / "umap_test_set.png"
    ...
    plot_path = best_path / "umap_val_set.png"
    plot_umap(all_embeddings, all_targets, {v: k for k, v in label2idx.items()}, plot_path, title=f"UMAP on val set")
