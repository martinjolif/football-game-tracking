...
from src.player_detection.api.config import INFERENCE_MODEL_PATH, DEVICE, CONFIDENCE_THRESHOLD, IOU_THRESHOLD, INFERENCE_IMG_SIZE
...
def detect_players_in_image(image_bytes: bytes) -> DetectionInferenceResponse:
    ...
    results = model(image_pil, device=DEVICE, iou=IOU_THRESHOLD, conf=CONFIDENCE_THRESHOLD, imgsz=INFERENCE_IMG_SIZE)
